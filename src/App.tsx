...
function App() {
  ...
  return (
    <>
      <section className="bg-[#191d1e] h-screen flex">
        <div className="w-[230px] bg-[#17181a] h-full py-4 pl-6 pr-3">
        ...
        <div className="w-[calc(100%-230px)] py-4 px-6">
...
function NavBtn({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex relative  items-center hover:bg-white/5 transition-all py-2 pl-5 text-gray-400 fill-gray-400 font-medium text-sm   ${
        comparison === true
